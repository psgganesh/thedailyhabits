<template>
  <div>
    <div class="atomic-canvas-list-even planboard-list">
      <h2 class="text-white text-center">Evening ( {{ eveningHabitsCount }} / {{ eveningHabits.length }} )</h2>
        ...
        >
        <a-card class="list-group-item item task-card" :class="taskClassStatus(element)" :bordered="true" v-for="element in eveningHabits" :key="element.name">
            <a-card-meta
