<template>
  <div>
    ...
    <a-row :gutter="16" class="my-10">
      <a-col :span="24">
        <a-input size="large" placeholder="Habit question"/>
      </a-col>
    </a-row>
    <a-row :gutter="16" class="my-10">
      <a-col :span="24">
        <a-textarea size="large" placeholder="Habit description (optional)" :rows="4" />
      </a-col>
    </a-row>
    <a-row :gutter="16" class="my-10" v-show="selectedTrackingOption === 2">
      <a-col :span="24">
        <h3 class="text-left">Mark as successful if number 
          <a-select defaultValue="exactly" style="width: 159px" size="medium">
          ...
          <a-input-number :min="1" :max="10" v-model="timesValue" size="medium" />
          times in a
          <a-select defaultValue="day" style="width: 120px" size="medium">
...
export default {
  ...
  data() {
    return {
      ...
      trackingOptions: [
        { id: 1, title: 'Simple Yes or No each time', description: 'Did you succeed in ___ today ?', avatar: 'https://img.icons8.com/color/96/000000/true-false.png' },
        { id: 2, title: 'With a number as a unit', description: 'How many ___ did you do today ?', avatar: 'https://img.icons8.com/color/96/000000/help.png' }
      ]
    }
  },
  methods: {
